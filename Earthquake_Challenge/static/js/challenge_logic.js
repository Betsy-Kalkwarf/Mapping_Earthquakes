...
let tetonicPlateData = new L.LayerGroup();
...
let overlays = {
  ...
  "Tetonic Plate Data": tetonicPlateData,
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  //Set style for tectonis plate data
  let myTectStyle = {
    color: "pink",
    weight: 1.5
  }
  ...
  }).addTo(tetonicPlateData);
  tetonicPlateData.addTo(map)
});
});